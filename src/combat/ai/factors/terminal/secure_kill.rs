...
use crate::combat::ai::planning::terminal::compute_secure_kill;
...
mod tests {
    ...
    #[test]
    fn terminal_factor_compute_matches_legacy_secure_kill() {
        ...
        let via_legacy = compute_secure_kill(&plan);
        assert_eq!(via_leaf, via_legacy, "secure_kill leaf must match legacy");
    }
}
