...
mod tests {
    ...
    #[test]
    fn terminal_factor_compute_matches_legacy_density_value() {
        ...
        let via_legacy = compute_density_value(&plan, &snap, &ctx);
        assert_eq!(via_leaf, via_legacy, "density_value leaf must match legacy");
    }
}
