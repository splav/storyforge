...
mod tests {
    ...
    #[test]
    fn terminal_factor_compute_matches_legacy_line_actionability() {
        ...
        let via_legacy = compute_line_actionability(&plan, &snap, &ctx);
        assert_eq!(via_leaf, via_legacy, "line_actionability leaf must match legacy");
    }
}
