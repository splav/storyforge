...
mod tests {
    ...
    #[test]
    fn terminal_factor_compute_matches_legacy_board_control_gain() {
        ...
        let via_legacy = compute_board_control_gain(&plan, &ctx);
        assert_eq!(via_leaf, via_legacy, "board_control_gain leaf must match legacy");
    }
}
