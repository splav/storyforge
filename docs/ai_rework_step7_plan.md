...
|---|---|---|---|---|
| 7.0 | Scaffolding (`PlanStage`, `ScoredPool`, `StageCtx`) | 0.5 | golden 0/N, no behavior | pending |
| 7.1 | Scoring stages (Viability + Sanity) | 1.0 | golden 0/N | pending |
| 7.2 | Contract stages (Adaptation + ProtectSelfMask + KillableGate) | 1.0 | golden 0/N | pending |
