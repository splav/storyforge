...
| R5 — pipeline/stages absorbs | R | partial | **только после P3a** | Mixed (move + split). A: done 2026-05-01 (critics/ + modifiers/ relocated). B.1: done 2026-05-01 (sanity split). B.2/B.3: pending (killable_gate/picker). |
